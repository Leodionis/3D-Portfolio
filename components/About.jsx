...
My knowledge extends to fundamental data structures and algorithms, making me well-versed in frontend web development.
        ...
        <Link
          href="document/RESUME_LEODIONIS.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
